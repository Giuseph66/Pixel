...
const GRIDS := {
	...
	"buff_run_pass_b": [
		...
		"......####CCCCCDDDDDDCCCCC####......",
		"......####CCCCCDDDDDDCCCCC####......",
		"...#DDccccCCCCCCCCCCCCCCCccccC##....",
		"...#CCCCCCCCCCCccCCcccccCCCCCCCC#...",
		"...#CCCCCCCCCCCccCCcccccCCCCCCCC#...",
		".##SCCCDDDDcCCCccCCccCCCcCDDCCCC#...",
		".##CCCCCSSCCCCCCCDCCCCCCCDSSCCCCC##.",
		".##CCCCCSSCCCCCCCDCCCCCCCDSSCCCCC##.",
		"#CCCCCCCSSSDDDCDDDDCCDDDDSDDcCCCC##.",
		"#CCCCCCC##SDDDDCCCCCCDDDSS##CCCCCCC#",
		"#CCCCCCC##SDDDDCCCCCCDDDSS##CCCCCCC#",
		"#CCCDDD#..#SDDDCCDCCCDCCS#..#DDDCCC#",
		"#CCCCC#....#CCCCCCCCCDCC#....#CCCCC#",
		"#CCCCC#....#CCCCCDCCCCCC#....#CCCCC#",
		"#CCCCC#....#CCCCCDCCCCCC#....#CCCCC#",
		"#CCCDD#....#DDDCCDCCCDDD#....#DDCCC#",
		"#CCCDD#...#CCCDDDCCDDDCC#....#DDcCC#",
		"#CCCDD#...#CCCDDDCCDDDCC#....#DDcCC#",
		"#CCCCCD#..#CCCCDDCCDDCccC#..#DCCCCC#",
		"#DDCCCD#..#CCCCDDSSDDCCCC#..#DCCC##.",
		"#DDCCCD#..#CCCCDDSSDDCCCC#..#DCCC##.",
		".##CDD#...#CCCCDD##DDCCCC#...#CCD##.",
		"...####...#DCCC##..##CCCD#...####...",
		"...####...#DCCC##..##CCCD#...####...",
		"..........#CDDS##..##SCCC#..........",
		"........##DCDD#......#DDC#..........",
	...
	# Regular jump, with or without horizontal movement. Head and torso stay
	# frontal; only the knees tuck upward, so lateral speed never twists him
