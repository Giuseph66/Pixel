...
const GRIDS := {
	...
	# --- bombado -------------------------------------------------------------
	# Sandbox-only super form (doc/bombadao). Twenty-six by thirty instead of
	# the usual eight by ten: the arms deliberately hang outside the collision
	# box, which is only fourteen wide, because a body this size reads by
	...
	# "player_idle" above — eight wide against twenty-six of shoulder. That is
	...
	"buff_idle": [
		...
		"..#CCCDCcCCcCCcCCcCDDCCS#.",
		".#CCCCSDCCCCCDCCCCCSCCCC#.",
		".#CCCcDSDDDCDDDCDDSSCCCCC#",
		"#CCCCC#SSDDCCCCDDDS#CCCCC#",
		"#CCDD#.#SCDCCDCDDS#.#DDCC#",
		"#CCC#...#CDCCCCCC#...#CCC#",
		"#CCC#...#CCCCDCCC#...#CCC#",
		"#CCD#...#DDCCDCDD#...#DCC#",
		"#CcD#...#CDDCCDDCC#..#DCC#",
		"#CCCD#.#CcCDCCDCCC#.#DCCC#",
		".#CCD#.#CCCDSSDCCC#.#DCCD#",
		".#DC#..#CCCD##DCCC#..#DC#.",
		"..###..#DCC#..#CCD#..###..",
		".......#CCS#..#SDC#.......",
	...
	"buff_rise": [
		...
		"#Cc#.....#wwccww#.....#cC#",
		"#CCC#..###w#cc#w###...#CC#",
		"#CCDC##cC#cccccc#Cc###DCC#",
		"#CCDCcCCC#CCCCCC#CCCcCDDC#",
		"#DCCDCCDCCccCCccCCDCCDCCD#",
		"##CCCDSDcCCCCCcCCcDSDCCC#.",
		"..#DCDSSCCCcCCcCCCSS#CD#..",
		"...###SCSDCCDDCCDSD#.##...",
		"......#CDDDCCCCDDDD#......",
		".......##DDCCCCCD##.......",
		".........#DCCCCD#.........",
	...
	"buff_pose_lat": [
		...
		"...#CcCcC#cccccc#CcccC#...",
		"...#CCCCC#CCCCCC#CcCCcC#..",
		"..#CCCDCcCCcCCcCcCCCCCC#..",
		".#cCCCDCcCCCCCCCCcCDCCCD#.",
		"#CCCCcDSCCCCDCCcCCDScCCC#.",
		"#CcDDC#SSDDDDDDDDSSDCCCCC#",
		"#CccC#.#DDCCCCCDDSD#DDCCC#",
		"#CCCC#..#CDCDCDCDD#.#CcCC#",
		"#DCCcC##DCDCCCDDD#.#CcCDC#",
		".##CCcCCDCCCDCDCSS#DcCCC#.",
		"...##CcDDDCCCCDDDcCcCCC##.",
		".....#DDCDDDDDDSDCCC###...",
		"......#CcDDCCDDCSDC#......",
		"......#cCCSDDSCcCSS#......",
	...
	"buff_pose_back": [
		...
		"#CCC#....#cccccc#....#CCC#",
		"#CcCS#####cccccc#####SDcC#",
		"#CCDcCCcc#cccccc#ccCccCCC#",
		"#CCCCCCcC#cccccc#CcCCCCCC#",
		"#SCCCDCCc#CCCCCC#cCCDCCD#.",
		".##CCDSDDDCCCCCCDDDSDCC##.",
		"...###DCDCCCCCCCCDCD###...",
		"......#CCCCCCCCCCCC#......",
		"......#CCCDDCCCDCCD#......",
		".......#DCCCDDCCCD#.......",
	...
	"buff_pose_kneel": [
		...
		"#CCC#..###w#cc#w#.........",
		"#CCCS##Cc#cccccc######....",
		"#CCDCcCCC#CCCCCC#ccCc#....",
		"#DDCCCCDCcCDCCcCCCCCCC#...",
		"#DCCDDSDccCCcCCCCCCCCCC##.",
		".##DCCSCcCCCCCCCCDDCCCCc#.",
		"...####CCCDCcCCCDSDccCCCC#",
		".......#CDSDCCDDSSSCCDCCC#",
		"........#CDCDDDDDDS#SCcCC#",
		"........#CDCCDCDDD#.#CCDC#",
