...
"en": {
	...
	"codex.wall.text": "TOUCH A WALL TO CLING. JUMP RIGHT AWAY AND YOU LEAVE FASTER",

	"level.boost_first.name": "RIGHT TOUCH",
	"level.boost_first.hint": "JUMP THE MOMENT YOU TOUCH THE WALL",
	"level.boost_zigzag.name": "ZIGZAG",
	"level.boost_zigzag.hint": "EVERY TOUCH IS BRIEF. THROW EACH JUMP",
	"level.boost_gap.name": "LONG JUMP",
	"level.boost_gap.hint": "TOUCH THE WALL HIGH. A MISS IS ONLY TIME",
	...
	"codex.pound.text": "DOWN IN THE AIR. BREAKS WHAT IS BELOW. COSTS YOUR LEGS: TWO SECONDS OF DASH ONLY, LOW ENOUGH TO PASS UNDER A TILE",
	...
	"options.footer": "LEFT/RIGHT VOLUME, SPACE CHANGE, ESC BACK",
	"options.back": "BACK",
	...
	"ending.rooms": "ROOMS",
	"ending.menu": "TITLE",
	"ending.choose_mode": "CHOOSE MODE",
	...
	"level.19.name": "SLAM",
	"level.19.hint": "IN THE AIR, HOLD DOWN TO POUND THROUGH",
	...
	# ---------------------------------------------------------- modifiers ---
	"mod.title": "PICK A TWIST",
	"mod.none.name": "CLASSIC",
	"mod.none.text": "NO TWIST. JUST THE RUN",
	"mod.rush.name": "RUSH",
	"mod.rush.text": "YOU MOVE FASTER. SO DO YOUR MISTAKES",
	"mod.heavy.name": "HEAVY",
	"mod.heavy.text": "GRAVITY WINS. EVERY JUMP IS SHORTER",
	"mod.brittle.name": "BRITTLE",
	"mod.brittle.text": "THE FLOOR GIVES WAY. DO NOT STAND STILL",
	"mod.dark.name": "DARK",
	"mod.dark.text": "YOU SEE ONLY WHAT IS NEAR",
	"mod.footer": "ARROWS TO CHOOSE, SPACE TO CONFIRM, ESC TO GO BACK",
	# ------------------------------------------------------------ ghost ---
	"codex.ghost.name": "GHOST BLOCK",
	"codex.ghost.text": "ONE IS THERE WHEN YOU REST, THE OTHER WHEN YOU RUN",
	"level.ghost_first.name": "STILL",
	"level.ghost_first.hint": "STAND ON IT. WALKING MAKES IT LEAVE",
	"level.ghost_move.name": "ON THE MOVE",
	"level.ghost_move.hint": "STOPPING IS WHAT DROPS YOU",
	"level.ghost_mix.name": "ALTERNATING",
	"level.ghost_mix.hint": "CLIMB IN BURSTS AND PAUSES",
	"level.ghost_gems.name": "THREE STATES",
	"level.ghost_gems.hint": "STILL, RUNNING, OR IN THE AIR",
	# ---------------------------------------------------------- gravity ---
	"codex.gravity.name": "FLIP ZONE",
	"codex.gravity.text": "INSIDE IT, DOWN IS UP. EVERYTHING ELSE STILL WORKS",
	"level.grav_first.name": "UPSIDE DOWN",
	"level.grav_first.hint": "WALK IN. THE ZONE DOES THE REST",
	"level.grav_gap.name": "DOUBLE GAP",
	"level.grav_gap.hint": "THE CEILING IS A FLOOR IN THERE",
	"level.grav_spike.name": "TWO FLOORS",
	"level.grav_spike.hint": "THE ZONE PICKS WHICH SURFACE IS YOURS",
	"level.grav_wall.name": "FLIPPED WALL",
	"level.grav_wall.hint": "THE WALL JUMP THROWS YOU DOWN IN HERE",
	"level.grav_pound.name": "HAMMER UP",
	"level.grav_pound.hint": "POUND NOW SLAMS TOWARD THE CEILING",
	# ------------------------------------------------------------- echo ---
	"codex.echo.name": "ECHO",
	"codex.echo.text": "YOU GO BACK ONE SECOND. THE ROOM DOES NOT",
	"level.echo_first.name": "GO BACK",
	"level.echo_first.hint": "ECHO IN MID-AIR TO RETURN TO THE LEDGE",
	"level.echo_reach.name": "DOUBLE REACH",
	"level.echo_reach.hint": "JUMP, ECHO AT THE PEAK, THEN JUMP AGAIN",
	"level.echo_break.name": "IT STAYS BROKEN",
	"level.echo_break.hint": "THE ROOM DOES NOT ECHO BACK WITH YOU",
	"level.echo_two.name": "TWO USES",
	"level.echo_two.hint": "SPEND THEM WHERE THEY COUNT",
	# ------------------------------------------------------------ clone ---
	"codex.clone.name": "GHOST CLONE",
	"codex.clone.text": "IT REPLAYS WHAT YOU JUST DID. IT HAS A BODY",
	"codex.sensor.name": "SENSOR",
	"codex.sensor.text": "IT NEEDS WEIGHT ON IT. YOURS OR SOMEONE ELSES",
	"pal.clone_pad.name": "RECORD START",
	"pal.clone_pad.note": "TOUCH IT TO START RECORDING YOUR CLONE",
	"pal.sensor.name": "SENSOR",
	"pal.sensor.note": "OPEN WHILE SOMETHING STANDS ON IT",
	"level.clone_first.name": "SHADOW",
	"level.clone_first.hint": "THE CLONE HAS TO STAND WHERE YOU DID",
	"level.clone_step.name": "LIVING STEP",
	"level.clone_step.hint": "RECORD YOURSELF AS A LEDGE FOR LATER",
	"level.clone_two.name": "TWO SENSORS",
	"level.clone_two.hint": "RECORD TWO CLONES, ONE SENSOR AT A TIME",
	"level.clone_race.name": "IN SYNC",
	"level.clone_race.hint": "BE ON THE OTHER SIDE WHEN THE CLONE ARRIVES",
	# ------------------------------------------------------- sandbox ---
	...
	"pal.laser_h.name": "LASER (SIDE)",
	"pal.laser_h.note": "FIRES ALONG ITS ROW. MOUNTS ON A SIDE WALL",
	"pal.laser_v.name": "LASER (UP/DOWN)",
	"pal.laser_v.note": "FIRES ALONG ITS COLUMN. MOUNTS ON A FLOOR OR CEILING",
	"pal.ferrybat.name": "FERRY BAT",
	"pal.ferrybat.note": "RIDE THE TOP. IT DIVES AFTER A FEW SECONDS",
	"pal.ghost_still.name": "GHOST (STILL)",
	"pal.ghost_still.note": "SOLID WHILE THE PLAYER IS ALMOST STOPPED",
	"pal.ghost_move.name": "GHOST (MOVING)",
	"pal.ghost_move.note": "SOLID ONLY WHILE THE PLAYER IS RUNNING",
	"pal.gravity.name": "FLIP ZONE",
	"pal.gravity.note": "FILLS AN AREA. GRAVITY POINTS UP INSIDE IT",
	"pal.no_dash.name": "NO DASH",
	"pal.no_dash.note": "STACKS WITH OTHER BACKDROPS. NO DASHING INSIDE IT",
	"pal.no_pound.name": "NO POUND",
	"pal.no_pound.note": "STACKS WITH OTHER BACKDROPS. NO GROUND POUND INSIDE IT",
},
...
"pt": {
	...
	"codex.wall.text": "ENCOSTE NA PAREDE. PULE NA HORA E SAI MAIS RAPIDO",

	"level.boost_first.name": "TOQUE CERTO",
	"level.boost_first.hint": "PULE NO INSTANTE EM QUE TOCAR A PAREDE",
	"level.boost_zigzag.name": "ZIGUE-ZAGUE",
	"level.boost_zigzag.hint": "TODO TOQUE E BREVE. JOGUE CADA PULO",
	"level.boost_gap.name": "SALTO LONGO",
	"level.boost_gap.hint": "TOQUE A PAREDE ALTO. ERRAR SO CUSTA TEMPO",
	...
	"codex.pound.text": "BAIXO NO AR. QUEBRA O QUE ESTA EMBAIXO. CUSTA SUAS PERNAS: DOIS SEGUNDOS SO DE DASH, BAIXO O BASTANTE PARA PASSAR SOB UM BLOCO",
	...
	"options.footer": "ESQ/DIR VOLUME, ESPACO MUDA, ESC VOLTAR",
	"options.back": "VOLTAR",
	...
	"ending.rooms": "SALAS",
	"ending.menu": "MENU",
	"ending.choose_mode": "ESCOLHER OUTRO MODO",
	...
	"level.19.hint": "NO AR, SEGURE BAIXO PARA QUEBRAR O CHAO",
	"level.20.name": "PORAO",
	...
	# ---------------------------------------------------------- modifiers ---
	"mod.title": "ESCOLHA UMA REGRA",
	"mod.none.name": "CLASSICO",
	"mod.none.text": "SEM REGRA. SO A CORRIDA",
	"mod.rush.name": "CORRIDA",
	"mod.rush.text": "VOCE CORRE MAIS. SEUS ERROS TAMBEM",
	"mod.heavy.name": "PESADO",
	"mod.heavy.text": "A GRAVIDADE GANHA. TODO PULO ENCURTA",
	"mod.brittle.name": "QUEBRADICO",
	"mod.brittle.text": "O CHAO CEDE. NAO FIQUE PARADO",
	"mod.dark.name": "ESCURIDAO",
	"mod.dark.text": "VOCE SO VE O QUE ESTA PERTO",
	"mod.footer": "SETAS ESCOLHEM, ESPACO CONFIRMA, ESC VOLTA",
	# ------------------------------------------------------------ ghost ---
	"codex.ghost.name": "BLOCO FANTASMA",
	"codex.ghost.text": "UM EXISTE PARADO, O OUTRO SO CORRENDO",
	"level.ghost_first.name": "PARADO",
	"level.ghost_first.hint": "FIQUE EM CIMA. ANDAR FAZ ELE SUMIR",
	"level.ghost_move.name": "EM MOVIMENTO",
	"level.ghost_move.hint": "PARAR E O QUE TE DERRUBA",
	"level.ghost_mix.name": "ALTERNADO",
	"level.ghost_mix.hint": "SUBA EM ARRANCADAS E PARADAS",
	"level.ghost_gems.name": "TRES ESTADOS",
	"level.ghost_gems.hint": "PARADO, CORRENDO OU NO AR",
	# ---------------------------------------------------------- gravity ---
	"codex.gravity.name": "ZONA INVERTIDA",
	"codex.gravity.text": "LA DENTRO, BAIXO E CIMA. O RESTO FUNCIONA IGUAL",
	"level.grav_first.name": "DE CABECA",
	"level.grav_first.hint": "ENTRE. A ZONA FAZ O RESTO",
	"level.grav_gap.name": "VAO DUPLO",
	"level.grav_gap.hint": "O TETO E CHAO LA DENTRO",
	"level.grav_spike.name": "DOIS CHAOS",
	"level.grav_spike.hint": "A ZONA ESCOLHE QUAL SUPERFICIE E SUA",
	"level.grav_wall.name": "PAREDE INVERTIDA",
	"level.grav_wall.hint": "O WALL JUMP TE JOGA PRA BAIXO AQUI",
	"level.grav_pound.name": "MARTELO PRA CIMA",
	"level.grav_pound.hint": "O POUND AGORA BATE NO TETO",
	# ------------------------------------------------------------- echo ---
	"codex.echo.name": "ECO",
	"codex.echo.text": "VOCE VOLTA UM SEGUNDO. A SALA NAO VOLTA",
	"level.echo_first.name": "VOLTA",
	"level.echo_first.hint": "ECOE NO AR PARA VOLTAR A BORDA",
	"level.echo_reach.name": "ALCANCE DOBRADO",
	"level.echo_reach.hint": "PULE, ECOE NO TOPO, PULE DE NOVO",
	"level.echo_break.name": "O MUNDO FICA",
	"level.echo_break.hint": "A SALA NAO VOLTA JUNTO COM VOCE",
	"level.echo_two.name": "DOIS USOS",
	"level.echo_two.hint": "GASTE ONDE VALE A PENA",
	# ------------------------------------------------------------ clone ---
	"codex.clone.name": "CLONE FANTASMA",
	"codex.clone.text": "ELE REPETE O QUE VOCE ACABOU DE FAZER. TEM CORPO",
	"codex.sensor.name": "SENSOR",
	"codex.sensor.text": "PRECISA DE PESO EM CIMA. SEU OU DE OUTRO",
	"pal.clone_pad.name": "INICIO DA GRAVACAO",
	"pal.clone_pad.note": "TOQUE PARA COMECAR A GRAVAR SEU CLONE",
	"pal.sensor.name": "SENSOR",
	"pal.sensor.note": "ABRE ENQUANTO ALGO ESTA EM CIMA",
	"level.clone_first.name": "SOMBRA",
	"level.clone_first.hint": "O CLONE TEM QUE FICAR ONDE VOCE FICOU",
	"level.clone_step.name": "DEGRAU VIVO",
	"level.clone_step.hint": "GRAVE-SE COMO UM DEGRAU PARA DEPOIS",
	"level.clone_two.name": "DOIS SENSORES",
	"level.clone_two.hint": "GRAVE DOIS CLONES, UM SENSOR DE CADA VEZ",
	"level.clone_race.name": "SINCRONIA",
	"level.clone_race.hint": "ESTEJA DO OUTRO LADO QUANDO O CLONE CHEGAR",
	# ------------------------------------------------------- sandbox ---
	"play.sandbox": "SANDBOX",
	...
	"pal.laser_h.name": "LASER (LADO)",
	"pal.laser_h.note": "DISPARA NA PROPRIA FILEIRA. GRUDA NUMA PAREDE LATERAL",
	"pal.laser_v.name": "LASER (CIMA/BAIXO)",
	"pal.laser_v.note": "DISPARA NA PROPRIA COLUNA. GRUDA NO CHAO OU NO TETO",
	"pal.ferrybat.name": "MORCEGO BALSA",
	"pal.ferrybat.note": "SUBA NO TOPO. MERGULHA APOS ALGUNS SEGUNDOS",
	"pal.ghost_still.name": "FANTASMA (PARADO)",
	"pal.ghost_still.note": "SOLIDO ENQUANTO O JOGADOR ESTA QUASE PARADO",
	"pal.ghost_move.name": "FANTASMA (MOVIMENTO)",
	"pal.ghost_move.note": "SOLIDO SO ENQUANTO O JOGADOR CORRE",
	"pal.gravity.name": "ZONA INVERTIDA",
	"pal.gravity.note": "PREENCHE UMA AREA. GRAVIDADE APONTA PRA CIMA",
	"pal.no_dash.name": "SEM DASH",
	"pal.no_dash.note": "SE COMBINA COM OUTROS FUNDOS. NAO DA PRA DAR DASH AQUI",
	"pal.no_pound.name": "SEM PISAO",
	"pal.no_pound.note": "SE COMBINA COM OUTROS FUNDOS. NAO DA PRA PISAR AQUI",
},
...
"es": {
	...
	"codex.wall.text": "TOCA LA PARED. SALTA DE INMEDIATO Y SALES MAS RAPIDO",

	"level.boost_first.name": "TOQUE JUSTO",
	"level.boost_first.hint": "SALTA EN EL INSTANTE QUE TOQUES LA PARED",
	"level.boost_zigzag.name": "ZIGZAG",
	"level.boost_zigzag.hint": "CADA TOQUE ES BREVE. LANZA CADA SALTO",
	"level.boost_gap.name": "SALTO LARGO",
	"level.boost_gap.hint": "TOCA LA PARED ARRIBA. FALLAR SOLO CUESTA TIEMPO",
	...
	"codex.pound.name": "IMPACTO",
	"codex.pound.text": "ABAJO EN EL AIRE. ROMPE LO DE ABAJO. CUESTA TUS PIERNAS: DOS SEGUNDOS SOLO DE DASH, BAJO PARA PASAR BAJO UN BLOQUE",
	...
	"options.footer": "IZQ/DER VOLUMEN, ESPACIO CAMBIA, ESC VOLVER",
	"options.back": "VOLVER",
	...
	"ending.rooms": "SALAS",
	"ending.menu": "MENU",
	"ending.choose_mode": "ELEGIR OTRO MODO",
	"title.endless": "INFINITO",
	...
	"level.19.name": "IMPACTO",
	"level.19.hint": "EN EL AIRE, MANTEN ABAJO PARA ROMPER EL SUELO",
	...
	# ---------------------------------------------------------- modifiers ---
	"mod.title": "ELIGE UNA REGLA",
	"mod.none.name": "CLASICO",
	"mod.none.text": "SIN REGLA. SOLO LA CARRERA",
	"mod.rush.name": "PRISA",
	"mod.rush.text": "CORRES MAS. TUS ERRORES TAMBIEN",
	"mod.heavy.name": "PESADO",
	"mod.heavy.text": "LA GRAVEDAD GANA. TODO SALTO ACORTA",
	"mod.brittle.name": "QUEBRADIZO",
	"mod.brittle.text": "EL SUELO CEDE. NO TE PARES",
	"mod.dark.name": "OSCURIDAD",
	"mod.dark.text": "SOLO VES LO QUE ESTA CERCA",
	"mod.footer": "FLECHAS ELIGEN, ESPACIO CONFIRMA, ESC VUELVE",
	# ------------------------------------------------------------ ghost ---
	"codex.ghost.name": "BLOQUE FANTASMA",
	"codex.ghost.text": "UNO EXISTE QUIETO, EL OTRO SOLO CORRIENDO",
	"level.ghost_first.name": "QUIETO",
	"level.ghost_first.hint": "QUEDATE ENCIMA. CAMINAR LO HACE IRSE",
	"level.ghost_move.name": "EN MOVIMIENTO",
	"level.ghost_move.hint": "PARARSE ES LO QUE TE HACE CAER",
	"level.ghost_mix.name": "ALTERNADO",
	"level.ghost_mix.hint": "SUBE EN ARRANQUES Y PAUSAS",
	"level.ghost_gems.name": "TRES ESTADOS",
	"level.ghost_gems.hint": "QUIETO, CORRIENDO O EN EL AIRE",
	# ---------------------------------------------------------- gravity ---
	"codex.gravity.name": "ZONA INVERTIDA",
	"codex.gravity.text": "AHI DENTRO, ABAJO ES ARRIBA. LO DEMAS IGUAL",
	"level.grav_first.name": "DE CABEZA",
	"level.grav_first.hint": "ENTRA. LA ZONA HACE EL RESTO",
	"level.grav_gap.name": "VACIO DOBLE",
	"level.grav_gap.hint": "EL TECHO ES SUELO AHI DENTRO",
	"level.grav_spike.name": "DOS PISOS",
	"level.grav_spike.hint": "LA ZONA ELIGE QUE SUPERFICIE ES TUYA",
	"level.grav_wall.name": "PARED INVERTIDA",
	"level.grav_wall.hint": "EL WALL JUMP TE TIRA HACIA ABAJO AQUI",
	"level.grav_pound.name": "MARTILLO ARRIBA",
	"level.grav_pound.hint": "EL POUND AHORA GOLPEA EL TECHO",
	# ------------------------------------------------------------- echo ---
	"codex.echo.name": "ECO",
	"codex.echo.text": "VUELVES UN SEGUNDO. LA SALA NO",
	"level.echo_first.name": "VUELVE",
	"level.echo_first.hint": "USA EL ECO EN EL AIRE PARA VOLVER AL BORDE",
	"level.echo_reach.name": "ALCANCE DOBLE",
	"level.echo_reach.hint": "SALTA, USA EL ECO ARRIBA, SALTA DE NUEVO",
	"level.echo_break.name": "EL MUNDO QUEDA",
	"level.echo_break.hint": "LA SALA NO VUELVE CONTIGO",
	"level.echo_two.name": "DOS USOS",
	"level.echo_two.hint": "GASTALOS DONDE VALGAN LA PENA",
	# ------------------------------------------------------------ clone ---
	"codex.clone.name": "CLON FANTASMA",
	"codex.clone.text": "REPITE LO QUE ACABAS DE HACER. TIENE CUERPO",
	"codex.sensor.name": "SENSOR",
	"codex.sensor.text": "NECESITA PESO ENCIMA. TUYO O DE OTRO",
	"pal.clone_pad.name": "INICIO DE GRABACION",
	"pal.clone_pad.note": "TOCALO PARA EMPEZAR A GRABAR TU CLON",
	"pal.sensor.name": "SENSOR",
	"pal.sensor.note": "ABRE MIENTRAS ALGO ESTE ENCIMA",
	"level.clone_first.name": "SOMBRA",
	"level.clone_first.hint": "EL CLON TIENE QUE PARARSE DONDE TU LO HICISTE",
	"level.clone_step.name": "ESCALON VIVO",
	"level.clone_step.hint": "GRABATE COMO UN ESCALON PARA DESPUES",
	"level.clone_two.name": "DOS SENSORES",
	"level.clone_two.hint": "GRABA DOS CLONES, UN SENSOR A LA VEZ",
	"level.clone_race.name": "SINCRONIA",
	"level.clone_race.hint": "ESTATE DEL OTRO LADO CUANDO LLEGUE EL CLON",
	# ------------------------------------------------------- sandbox ---
	"play.sandbox": "SANDBOX",
	...
	"pal.laser_h.name": "LASER (LADO)",
	"pal.laser_h.note": "DISPARA EN SU FILA. SE MONTA EN UN MURO LATERAL",
	"pal.laser_v.name": "LASER (ARRIBA/ABAJO)",
	"pal.laser_v.note": "DISPARA EN SU COLUMNA. SE MONTA EN EL SUELO O TECHO",
	"pal.ferrybat.name": "MURCIELAGO BALSA",
	"pal.ferrybat.note": "SUBE ENCIMA. SE ZAMBULLE TRAS UNOS SEGUNDOS",
	"pal.ghost_still.name": "FANTASMA (QUIETO)",
	"pal.ghost_still.note": "SOLIDO MIENTRAS EL JUGADOR ESTA CASI QUIETO",
	"pal.ghost_move.name": "FANTASMA (MOVIMIENTO)",
	"pal.ghost_move.note": "SOLIDO SOLO MIENTRAS EL JUGADOR CORRE",
	"pal.gravity.name": "ZONA INVERTIDA",
	"pal.gravity.note": "LLENA UN AREA. LA GRAVEDAD APUNTA HACIA ARRIBA",
	"pal.no_dash.name": "SIN DASH",
	"pal.no_dash.note": "SE COMBINA CON OTROS FONDOS. NO SE PUEDE HACER DASH AQUI",
	"pal.no_pound.name": "SIN PISON",
	"pal.no_pound.note": "SE COMBINA CON OTROS FONDOS. NO SE PUEDE PISAR AQUI",
},
}
